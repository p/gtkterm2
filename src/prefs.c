...
gtkTermMPref* gtkTermMPref_init(gtkTermPref* pref)
{
	...
	pref->mpref[pref->mprefSize]->colors[7].red   = 0xcccc;
	pref->mpref[pref->mprefSize]->colors[7].green = 0xcccc;
	pref->mpref[pref->mprefSize]->colors[7].blue  = 0xcccc;
...
int gtkTermPref_save(gtkTermPref* pref, GString *path)
{
	...
	fprintf(gtkTermRC_FP, "##\n# NEW COLOR Definition (18 values: Back Fore ANSI0-15)\n##\n");
	fprintf(gtkTermRC_FP, "#   Back   Fore   Black  Red    Green  Yellow Blue   Magent Cyan   White  BrtBlk BrtRed BrtGrn BrtYel BrtBlu BrtMag BrtCyn BrtWht\n");
